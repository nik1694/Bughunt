...
<body>
	...
	<%
		//request.setAttribute("uname", request.getAttribute("uname"));
		String s = "" + request.getSession().getAttribute("uname");
		String type = "" + request.getSession().getAttribute("type");

		ProjectDao dao = new ProjectDao();
		System.out.print(s);
		System.out.print(type);
		ArrayList<BugMaster> buges = new ArrayList();
		if (request.getSession().getAttribute("type")!=null) {
			...
			case 1:
				...
				<br>Showing all bug for <%=s %> 
				<%
				buges = dao.getAllTopBuges(s);
				break;
			case 2:
				%>
				
				<br>Showing solved bug for <%=s %> 
				<%
				buges = dao.getAllSolvedBuges(s);
				break;
			case 3:
				%>
				<br>Showing unsolved bug for <%=s %> 
				<%
				buges = dao.getAllUnSolvedBuges(s);
				break;
			default:
				buges = dao.getAllTopBuges(s);
	...
	<div id="page-wrapper">
		...
		<div class="container-fluid">
			<form action="../BugController" method="get">
				Enter Developer ID : <input type="text" value="<%=s%>" name="uname">
				...
				<div class="radio">
					<label><input type="radio" required name="type" value="2">
						Solved </label>
				</div>
				<div class="radio disabled">
					<label><input type="radio" required name="type" value="3">
						UnSolved </label>
				</div>
